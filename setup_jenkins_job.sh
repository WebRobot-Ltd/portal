...
# Script per configurare il job Jenkins per WebRobot Portal
...
#   cd /path/to/webrobot-vitepress-site
#   export JENKINS_TOKEN=il_tuo_token
#   ./setup_jenkins_job.sh

set -e

echo "🚀 SETUP JENKINS JOB PER WEBROBOT PORTAL"
echo "========================================="
...
JOB_NAME="webrobot-portal-pipeline"
...
create_job_xml() {
    ...
    cat > /tmp/webrobot-portal-job.xml << 'EOF'
<?xml version='1.1' encoding='UTF-8'?>
<flow-definition plugin="workflow-job@1385.va39f2f9da_8ce">
  <description>WebRobot Portal - VitePress showcase site with demo apps</description>
    ...
    <scm class="hudson.plugins.git.GitSCM" plugin="git@5.2.1">
      ...
      <userRemoteConfigs>
        <hudson.plugins.git.UserRemoteConfig>
          <url>https://github.com/WebRobot-Ltd/portal.git</url>
...
create_jenkins_job() {
    ...
    $JENKINS_CMD create-job "$JOB_NAME" < /tmp/webrobot-portal-job.xml
...
show_info() {
    ...
    echo "📁 Repository: https://github.com/WebRobot-Ltd/portal"
    ...
    echo "   - Push su branch main (ogni 15 minuti)"
...
main() {
    echo ""
    echo "🎯 OBIETTIVO: Configurare job Jenkins per WebRobot Portal"
    echo ""
